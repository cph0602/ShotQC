...
if __name__ == "__main__":
    test_list = [i for i in range(10, 65)]
    for idx in test_list:
        try:
            ...
            circuit.qasm(filename = "supremacy_"+str(idx)+".qasm")
            #print(circuit)
            '''
            ...
            for num_subcirc in range(len(cutqc.subcircuits)):
                cutqc.subcircuits[num_subcirc].qasm(filename = "supremacy_"+str(idx)+"_subcircuit_"+str(num_subcirc)+".qasm")
