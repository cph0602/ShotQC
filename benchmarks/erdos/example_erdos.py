...
if __name__ == "__main__":
    test_list = [i for i in range(10, 41)]
    result_list = []
    for idx in test_list:
        try:
            ...
            circuit.qasm(filename = "erdos_"+str(idx)+".qasm")
            ...
            for num_subcirc in range(len(cutqc.subcircuits)):
                cutqc.subcircuits[num_subcirc].qasm(filename = "erdos_"+str(idx)+"_subcircuit_"+str(num_subcirc)+".qasm")
